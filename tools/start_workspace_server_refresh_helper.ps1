...
$fallbackPath = Join-Path $toolsRoot 'workspace_server_sync_fallback.json'
...
python tools\workspace_server_refresh_helper.py --config $configPath --fallback-output $fallbackPath
