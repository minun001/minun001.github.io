...
- Autonomous driving and anticipatory decision-making  
- Front-vehicle maneuver & trajectory prediction (e.g., TGCA-based models)  
- AI-based speaker diarization and child–parent interaction analysis (CRC datasets)  
- Smart grid & energy management using AI  
- Data-driven safety and risk prediction in mobility systems  
...
- 🔬 **National research projects (NRF CRC, etc.)**  
  - Bridging academic models with real-world applications in mobility and safety  
- 💡 Continuous focus on **AI systems deployable in real environments**, not just simulations  
...
- Goal: enable anticipatory driving beyond rule/threshold-based control
