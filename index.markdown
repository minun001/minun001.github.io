...
.hs-focus-card::before {
  ...
  width: 100%;
  height: 4px;
  background: linear-gradient(90deg, rgba(29, 78, 216, 0.95), rgba(16, 185, 129, 0.8));
}
...
.hs-feature-card:first-child {
  grid-column: span 5;
}

.hs-feature-card:nth-child(2) {
  grid-column: span 3;
}

.hs-feature-card:nth-child(3) {
  grid-column: span 4;
}
