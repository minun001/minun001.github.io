...
function renderHeader(dataset) {
  ...
  byId("page-eyebrow").textContent = `${dataset.label} Leaderboard`;
  byId("page-title").textContent = `${dataset.label} Leaderboard`;
  byId("page-lede").textContent =
    "Baseline models and the default TGCA are compared here. Ablation variants are excluded from the ranking.";
